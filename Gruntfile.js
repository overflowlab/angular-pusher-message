module.exports = function (grunt) {
        ...
        stylus: {
            compile: {
                files: {
                    ...
                    'styles/angular-live-pusher-message.css': 'styles/angular-live-pusher-message.styl'
                }
            }
        },
        copy: {
            ...
            bowerFiles: {
                files: [
                    {
                        expand: true,
                        src:  'app/angular-live-pusher-message.js',
                        flatten: true,
                        dest: 'angular-live-pusher-message/js'
                    },
                    {
                        expand: true,
                        src:  'styles/angular-live-pusher-message.css',
                        flatten: true,
                        dest: 'angular-live-pusher-message/css'
                    } 
    ...
    grunt.registerTask('bower_package', [
        'copy:bowerFiles'
    ]);
